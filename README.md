...
- raw EE kernel syscall wrappers plus public INTC/DMAC critical-section helpers, direct EE timer primitives and lightweight COP0 Count profiling counters;
