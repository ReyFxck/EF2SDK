...
cp build/ef2storage.irx "${STAGE}/iop/"
...
cp docs/ARCHITECTURE.md docs/ROADMAP.md docs/AUDIO.md docs/PAD.md docs/VIDEO.md docs/RUNTIME.md docs/KERNEL.md docs/STORAGE.md docs/THIRD_PARTY_PROTOCOLS.md ports/zlib/README.md "${STAGE}/docs/"
