...
$(BUILD)/boot.o: examples/boot/main.c include/ef2/audio.h include/ef2/base.h include/ef2/crash.h include/ef2/debug.h include/ef2/pad.h include/ef2/video.h | $(BUILD)
	$(CC) $(CFLAGS) -c $< -o $@
