...
check: $(ELF) $(IOP_AUDIO_IRX) $(IOP_PAD_IRX)
	...
	@for sym in ef2_video_init ef2_audio_rate_converter_init ef2_audio_rate_converter_process_s16 ef2_sif_init ef2_audio_device_init ef2_audio_device_start ef2_pad_init ef2_pad_poll ef2_pad_poll_all ef2_pad_set_rumble ef2_pad_stop_rumble ef2_pad_is_held ef2_pad_axis_deadzone; do \
